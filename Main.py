...
class Main(tk.Frame):
    ...
    def init_main(self):
        toolbar = tk.Frame(bg="#57b0ff", bd=2)
        toolbar.pack(side=tk.TOP, fill=tk.X)
        
        # Кнопка добавления

        self.img_add = tk.PhotoImage(file="C:\\Users\\pc\\Desktop\\Project\\add.png")
        btn_add = tk.Button(toolbar, text="Добавить", bg="#1446a3",
        ...
        self.img_upd = tk.PhotoImage(file="C:\\Users\\pc\\Desktop\\Project\\change.png")
        btn_upd = tk.Button(toolbar, bg="#1446a3",
                            bd = 0, image=self.img_upd,
                            command=self.open_update_child)
        btn_upd.pack(side=tk.LEFT)

        # Кнопка поиска
        self.img_search = tk.PhotoImage(file="C:\\Users\\pc\\Desktop\\Project\\search.png")
        btn_search = tk.Button(toolbar, bg="#1446a3", 
                               bd = 0, image=self.img_search,
                               command=self.open_searc)
        btn_search.pack(side=tk.LEFT)

        # Кнопка обновления
        self.img_refresh = tk.PhotoImage(file="C:\\Users\\pc\\Desktop\\Project\\refresh.png")
        btn_refresh = tk.Button(toolbar, bg="#1446a3",
